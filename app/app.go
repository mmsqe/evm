...
// BASED extends an ABCI application, but with most of its parameters exported.
type BASED struct {
	*baseapp.BaseApp
...
func NewApp(
	...
	evmChainID uint64,
	evmAppOptions func(uint64) error,
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		...
		authtypes.ProtoBaseAccount, GetMaccPerms(),
...
func (app *BASED) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *BASED) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *BASED) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *BASED) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *BASED) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *BASED) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *BASED) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *BASED) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns AppD's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *BASED) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns AppD's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *BASED) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns AppD's InterfaceRegistry
func (app *BASED) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns AppD's TxConfig
func (app *BASED) TxConfig() client.TxConfig {
	return app.txConfig
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *BASED) DefaultGenesis() map[string]json.RawMessage {
...
func (app *BASED) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *BASED) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *BASED) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *BASED) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *BASED) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *BASED) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *BASED) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *BASED) RegisterTendermintService(clientCtx client.Context) {
...
func (app *BASED) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *BASED) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *BASED) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *BASED) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *BASED) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *BASED) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *BASED) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *BASED) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *BASED) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *BASED) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *BASED) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *BASED) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *BASED) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *BASED) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *BASED) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *BASED) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *BASED) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}

func (app *BASED) GetMintKeeper() mintkeeper.Keeper {
	return app.MintKeeper
}

func (app *BASED) GetPreciseBankKeeper() *precisebankkeeper.Keeper {
	return &app.PreciseBankKeeper
}

func (app *BASED) GetCallbackKeeper() ibccallbackskeeper.ContractKeeper {
	return app.CallbackKeeper
}

func (app *BASED) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *BASED) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *BASED) GetAnteHandler() sdk.AnteHandler {
	return app.AnteHandler()
}

// GetTxConfig implements the TestingApp interface.
func (app *BASED) GetTxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *BASED) AutoCliOpts() autocli.AppOptions {
