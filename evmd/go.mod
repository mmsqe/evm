...
replace (
	cosmossdk.io/store => github.com/mmsqe/cosmos-sdk/store v0.0.0-20250905083348-4b53f3f11f09
	github.com/cosmos/cosmos-sdk => github.com/mmsqe/cosmos-sdk v0.46.0-beta2.0.20250905083348-4b53f3f11f09
)
