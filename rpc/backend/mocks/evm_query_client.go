...
// EVMQueryClient_Precompile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Precompile'
type EVMQueryClient_Precompile_Call struct {
	*mock.Call
}

// Precompile is a helper method to define mock.On call
//   - ctx context.Context
//   - in *types.QueryPrecompileRequest
//   - opts ...grpc.CallOption
func (_e *EVMQueryClient_Expecter) Precompile(ctx interface{}, in interface{}, opts ...interface{}) *EVMQueryClient_Precompile_Call {
	return &EVMQueryClient_Precompile_Call{Call: _e.mock.On("Precompile",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *EVMQueryClient_Precompile_Call) Run(run func(ctx context.Context, in *types.QueryPrecompileRequest, opts ...grpc.CallOption)) *EVMQueryClient_Precompile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*types.QueryPrecompileRequest), variadicArgs...)
	})
	return _c
}

func (_c *EVMQueryClient_Precompile_Call) Return(_a0 *types.QueryPrecompileResponse, _a1 error) *EVMQueryClient_Precompile_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EVMQueryClient_Precompile_Call) RunAndReturn(run func(context.Context, *types.QueryPrecompileRequest, ...grpc.CallOption) (*types.QueryPrecompileResponse, error)) *EVMQueryClient_Precompile_Call {
	_c.Call.Return(run)
	return _c
}
